...
var globalConfig = explorer.load(process.cwd()) || {};

var set = exports.set = function set(key, value) {
  var maxAge = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : globalConfig.maxAge;
...
var observeData = function observeData(defaultKey, dataFn, onNext, onError) {
  ...
  var _globalConfig$options = _extends({}, globalConfig, options),
      maxAge = _globalConfig$options.maxAge,
      noCache = _globalConfig$options.noCache,
      pollInterval = _globalConfig$options.pollInterval;
