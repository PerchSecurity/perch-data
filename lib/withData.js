  ...
  function enhance(WrappedComponent) {
    ...
    return _temp = _class = function (_React$Component) {
      ...
      function _class(props) {
        ...
        _this.state = { obeserveIds: [], data: data };
        return _this;
      }
      ...
      _createClass(_class, [{
        ...
        value: function componentWillUnmount() {
          var obeserveIds = this.state.obeserveIds;

          obeserveIds.forEach(function (cacheKey) {
      ...
      this.getData = function (actionName, options) {
        ...
        }, mergedOptions.nocache).then(function (obeserveId) {
          _this3.setState(function (prevState) {
            return (0, _immutabilityHelper2.default)(prevState, {
