...
var Data = function (_React$Component) {
  ...
  function Data(props, context) {
    ...
    _this.onNext = function (data) {
      if (data && !(0, _lodash2.default)(data, _this.state.data)) {
    ...
    _this.fetchData = function (overrides) {
      ...
      store.observeData(null, actionWithVariables, _this.onNext, _this.onError, _extends({}, options, overrides)).then(function (_ref) {
